  ...
  return (
    <div className="home">
      ...
      <div className="home__feature">
        <button className="home__feature__button" onClick={() => goPage("https://www.seoultech.ac.kr/index.jsp")}>
          <img src={univIcon} alt="" className="home__feature__icon" />
          <p className="home__feature__text">과기대 홈페이지</p>
        </button>
        <button className="home__feature__button" onClick={() => goPage("https://stportal.seoultech.ac.kr/")}>
          <img src={potalIcon} alt="" className="home__feature__icon" />
          <p className="home__feature__text">과기대 포털</p>
        </button>
        <button
        ...
        >
          ...
          <p className="home__feature__text">e캠퍼스</p>
        </button>
        <button className="home__feature__button" onClick={() => goPage("https://library.seoultech.ac.kr/#/")}>
          <img src={bookIcon} alt="" className="home__feature__icon" />
          <p className="home__feature__text">ST LIBRARY</p>
        </button>
      </div>
    </div>
  );
